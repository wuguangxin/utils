...
public class FontUtils{
	 ...
	 *
	 * @param textView
	 * @param filePath assets下的文件路径 "fonts/xxx.ttf";
	 */
	public static void setTypefaceFromAsset(TextView textView, String filePath) {
		Typeface typeface = Typeface.createFromAsset(textView.getContext().getAssets(), filePath);

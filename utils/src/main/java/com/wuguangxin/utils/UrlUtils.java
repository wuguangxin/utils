...
/**
 * URL工具类.
 * <br/> Created by wuguangxin on 14/8/20
 */
public class UrlUtils {
    ...
    public static String encode(String data, String charsetName) {
        ...
        try {
            return URLEncoder.encode(data, charsetName);
     ...
     * @return
     */
    public static String replaceValue(String url, String key, String value) {
        if (!TextUtils.isEmpty(url) && !TextUtils.isEmpty(key)) {
            String reg = "(" + key + "=[^&]*)";
            url = url.replaceAll(reg, key + "=" + value);
        }
        return url;
    }
}
